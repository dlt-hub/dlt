...
lint-and-test-examples:
	...
	cd docs/examples/postgres_to_postgres && wget http://extensions.duckdb.org/v0.9.2/linux_amd64_gcc4/postgres_scanner.duckdb_extension.gz && gunzip ./postgres_scanner.duckdb_extension.gz
