...
class SupportsJson(t.Protocol):
    ...
    def dump(
        self, obj: t.Any, fp: t.IO[bytes], sort_keys: bool = False, pretty: bool = False
    ) -> None:
        ...

    def typed_dump(self, obj: t.Any, fp: t.IO[bytes], pretty: bool = False) -> None:
        ...

    def typed_dumps(self, obj: t.Any, sort_keys: bool = False, pretty: bool = False) -> str:
        ...

    def typed_loads(self, s: str) -> t.Any:
        ...

    def typed_dumpb(self, obj: t.Any, sort_keys: bool = False, pretty: bool = False) -> bytes:
        ...

    def typed_loadb(self, s: t.Union[bytes, bytearray, memoryview]) -> t.Any:
        ...

    def dumps(self, obj: t.Any, sort_keys: bool = False, pretty: bool = False) -> str:
        ...

    def dumpb(self, obj: t.Any, sort_keys: bool = False, pretty: bool = False) -> bytes:
        ...

    def load(self, fp: t.IO[bytes]) -> t.Any:
        ...

    def loads(self, s: str) -> t.Any:
        ...

    def loadb(self, s: t.Union[bytes, bytearray, memoryview]) -> t.Any:
        ...


def custom_encode(obj: t.Any) -> str:
...
DECODERS: t.List[t.Callable[[t.Any], t.Any]] = [
    Decimal,
    pendulum.parse,
...
def custom_pua_encode(obj: t.Any) -> str:
...
def custom_pua_decode(obj: t.Any) -> t.Any:
...
def custom_pua_decode_nested(obj: t.Any) -> t.Any:
...
def custom_pua_remove(obj: t.Any) -> t.Any:
