...
from dlt.common.schema.typing import TColumnName, TColumnSchema, C_DLT_ID, DLT_NAME_PREFIX, TTableSchema
...
def requires_root_key(schema: Schema, root_table: TTableSchema, root_key_propagation: Optional[bool]) -> bool:
    ...
    if table_name in schema.dlt_table_names():
        ...
        merge_requires = merge_strategy in ["delete-insert", "upsert"] if root_key_propagation is None else root_key_propagation
    return merge_requires \
            or any(
