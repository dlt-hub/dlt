...
from dlt.common.typing import TSecretValue, TSecretStrValue, DictStrAny
from dlt.common.configuration.specs.base_configuration import CredentialsConfiguration, configspec


@configspec
class SFTPCredentials(CredentialsConfiguration):
    """Credentials for SFTP filesystem, compatible with fsspec/sftp"""

    # TODO: separate config and secrets
    sftp_port: str = None
    sftp_username: str = None
    sftp_password: Optional[TSecretStrValue] = None
    sftp_key_filename: Optional[TSecretStrValue] = None  # path to the private key file
    sftp_key_passphrase: Optional[TSecretStrValue] = None  # passphrase for the private key
