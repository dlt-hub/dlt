...
from dlt._dataset.utils import get_destination_clients
...
def is_same_physical_destination(dataset: Dataset, other: Dataset) -> bool:
    """
...
class Dataset:
    """Access data stored on a dlt destination."""
    ...
    @property
    def sqlglot_dialect(self) -> Union[TSqlGlotDialect, None]:
    ...
    def __str__(self) -> str:
        ...
        msg = f"Dataset `{self._name}` at `{destination_info}` {schema_info}"
        if _schema:
