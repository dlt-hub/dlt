...
from typing import ClassVar, Dict, List, Optional, Sequence, Tuple, Type, cast
...
from dlt.destinations.bigquery.sql_client import BQ_TERMINAL_REASONS, BigQuerySqlClient
