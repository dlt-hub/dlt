...
class ReadableIbisRelation(BaseReadableDBAPIRelation):
    ...
    def _query(self) -> sge.Query:
        from dlt.helpers.ibis import duckdb_compiler, bigquery_compiler
        ...
        selected_compiler = (
            bigquery_compiler if destination_dialect == "bigquery" else duckdb_compiler
        )

        select_query = selected_compiler.to_sqlglot(self._ibis_object)
