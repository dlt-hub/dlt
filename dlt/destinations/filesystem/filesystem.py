...
from typing import ClassVar, Iterable, List, Sequence, Type, cast
...
from dlt.common.schema.typing import LOADS_TABLE_NAME, TWriteDisposition
...
from dlt.destinations.job_impl import EmptyLoadJob, NewLoadJobImpl, NewReferenceJob
...
class FilesystemClient(JobClientBase):
    ...
    def start_file_load(self, table: TTableSchema, file_path: str, load_id: str) -> LoadJob:
        ...
        has_merge_keys = any(
            col["merge_key"] or col["primary_key"] for col in table["columns"].values()
        )
        return cls(
            file_path,
            self.dataset_path,
