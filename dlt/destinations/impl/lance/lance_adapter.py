...
def lance_adapter(
    ...
    Args:
        data (Any): The data to be transformed. It can be raw data or an instance
            ...
            object.
        embed (TColumnNames): Specify columns to generate embeddings for.
    ...
    Raises:
        ValueError: If input for `embed` is invalid or empty, or no arguments are provided.
    ...
    if column_hints or additional_table_hints or merge_key:
        ...
        raise ValueError(
            "You must provide at least either the `embed` or `merge_key` or `remove_orphans`"
