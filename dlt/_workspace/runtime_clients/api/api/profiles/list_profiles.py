...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ErrorResponse400 | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ListProfilesResponse200]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse400 | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ListProfilesResponse200
    """
