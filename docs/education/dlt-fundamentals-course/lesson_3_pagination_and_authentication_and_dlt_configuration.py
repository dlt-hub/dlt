...
def _(RESTClient):
    ...
    client_1 = RESTClient(base_url="https://api.github.com", paginator=HeaderLinkPaginator())
    return (client_1,)
...
def _(mo):
    mo.md(
        r"""**If you're running this notebook as a Marimo Notebook**, you can simply use an environment variable:"""
    )
    return
