...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""To get started with data contracts, first install `dlt`:""")
    return
...
def _(mo):
    mo.md(
        r"""✅ ▶ Proceed to the [next lesson](https://colab.research.google.com/drive/1YCjHWMyOO9QGC66t1a5bIxL-ZUeVKViR#forceEdit=true&sandboxMode=true)!"""
    )
    return
