...
- [Load data from Zendesk to CockroachDB in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-cockroachdb)
- [Load data from Zendesk to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-filesystem-local)
...
- [Load data from Zendesk to Timescale in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-timescale)
...
- [Load data from Zendesk to Azure Cosmos DB in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-cosmosdb)
