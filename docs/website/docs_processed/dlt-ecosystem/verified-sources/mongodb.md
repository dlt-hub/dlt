...
- [Load data from MongoDB to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-snowflake)
- [Load data from MongoDB to Supabase in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-supabase)
...
- [Load data from MongoDB to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-synapse)
- [Load data from MongoDB to Azure Cosmos DB in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-cosmosdb)
- [Load data from MongoDB to CockroachDB in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-cockroachdb)
...
- [Load data from MongoDB to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-filesystem-local)
