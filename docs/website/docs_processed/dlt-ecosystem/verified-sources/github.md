...
Read more about [incremental loading](../../general-usage/incremental/cursor.md).
...
- [Load data from GitHub to Azure Cloud Storage in python with dlt](https://dlthub.com/docs/pipelines/github/load-data-with-python-from-github-to-filesystem-az)
...
- [Load data from GitHub to EDB BigAnimal in python with dlt](https://dlthub.com/docs/pipelines/github/load-data-with-python-from-github-to-biganimal)
...
- [Load data from GitHub to CockroachDB in python with dlt](https://dlthub.com/docs/pipelines/github/load-data-with-python-from-github-to-cockroachdb)
