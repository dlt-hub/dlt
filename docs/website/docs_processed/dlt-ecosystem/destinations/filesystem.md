...
| Feature | Value | More |
|---------|-------|------|
| Preferred Loader File Format | jsonl | [Data Types](../../general-usage/schema#data-types) |
| Supported Loader File Formats | jsonl, insert_values, parquet, csv, model, reference | [File Formats](../file-formats/) |
...
- [Load data from Azure Cloud Storage to Neon Serverless Postgres in python with dlt](https://dlthub.com/docs/pipelines/filesystem-az/load-data-with-python-from-filesystem-az-to-neondb)
- [Load data from Crypt API to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/crypt_api/load-data-with-python-from-crypt_api-to-filesystem-local)
- [Load data from Azure Cloud Storage to CockroachDB in python with dlt](https://dlthub.com/docs/pipelines/filesystem-az/load-data-with-python-from-filesystem-az-to-cockroachdb)
- [Load data from Qualtrics to AWS S3 in python with dlt](https://dlthub.com/docs/pipelines/qualtrics/load-data-with-python-from-qualtrics-to-filesystem-aws)
- [Load data from AWS S3 to Dremio in python with dlt](https://dlthub.com/docs/pipelines/filesystem-aws/load-data-with-python-from-filesystem-aws-to-dremio)
- [Load data from Harvest to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/harvest/load-data-with-python-from-harvest-to-filesystem-local)
- [Load data from Coinbase to Google Cloud Storage in python with dlt](https://dlthub.com/docs/pipelines/coinbase/load-data-with-python-from-coinbase-to-filesystem-gcs)
...
- [Load data from Zuora to AWS S3 in python with dlt](https://dlthub.com/docs/pipelines/zuora/load-data-with-python-from-zuora-to-filesystem-aws)
- [Load data from Azure Cloud Storage to Databricks in python with dlt](https://dlthub.com/docs/pipelines/filesystem-az/load-data-with-python-from-filesystem-az-to-databricks)
