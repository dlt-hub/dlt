...
| Supported Staging File Formats | parquet, model | [File Formats](../file-formats/) |
...
*This table shows the supported features of the Athena destination in dlt.*
...
- [Load data from Klaviyo to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/klaviyo/load-data-with-python-from-klaviyo-to-athena)
- [Load data from Looker to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/looker/load-data-with-python-from-looker-to-athena)
- [Load data from Clubhouse to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/clubhouse/load-data-with-python-from-clubhouse-to-athena)
- [Load data from MySQL to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/sql_database_mysql/load-data-with-python-from-sql_database_mysql-to-athena)
...
- [Load data from DigitalOcean to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/digitalocean/load-data-with-python-from-digitalocean-to-athena)
- [Load data from Chargebee to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/chargebee/load-data-with-python-from-chargebee-to-athena)
- [Load data from Rest API to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/rest_api/load-data-with-python-from-rest_api-to-athena)
- [Load data from Crypt API to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/crypt_api/load-data-with-python-from-crypt_api-to-athena)
