...
*This table shows the supported features of the Redshift destination in dlt.*
...
- [Load data from Harvest to Redshift in python with dlt](https://dlthub.com/docs/pipelines/harvest/load-data-with-python-from-harvest-to-redshift)
...
- [Load data from Cisco Meraki to Redshift in python with dlt](https://dlthub.com/docs/pipelines/cisco_meraki/load-data-with-python-from-cisco_meraki-to-redshift)
- [Load data from IFTTT to Redshift in python with dlt](https://dlthub.com/docs/pipelines/ifttt_service/load-data-with-python-from-ifttt_service-to-redshift)
- [Load data from Capsule CRM to Redshift in python with dlt](https://dlthub.com/docs/pipelines/capsule_crm/load-data-with-python-from-capsule_crm-to-redshift)
