...
| Preferred Staging File Format | jsonl | [Data Types](../../general-usage/schema#data-types) |
...
- [Load data from Sentry to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/sentry/load-data-with-python-from-sentry-to-snowflake)
- [Load data from IBM Db2 to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/sql_database_db2/load-data-with-python-from-sql_database_db2-to-snowflake)
- [Load data from Bitbucket to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/bitbucket/load-data-with-python-from-bitbucket-to-snowflake)
...
- [Load data from Vimeo to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/vimeo/load-data-with-python-from-vimeo-to-snowflake)
...
- [Load data from Aladtec to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/aladtec/load-data-with-python-from-aladtec-to-snowflake)
...
- [Load data from The Local Filesystem to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/filesystem-local/load-data-with-python-from-filesystem-local-to-snowflake)
- [Load data from Klaviyo to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/klaviyo/load-data-with-python-from-klaviyo-to-snowflake)
