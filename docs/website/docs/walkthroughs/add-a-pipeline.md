...
For adding them locally or on your orchestrator, please see the following guide [credentials](./customisation/credentials.md)

For getting the destination credentials, please see the [guide](./destinations/credentials.md).
