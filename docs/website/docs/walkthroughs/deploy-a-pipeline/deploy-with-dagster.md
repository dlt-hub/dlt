...
[documentation.]https://docs.dagster.io/getting-started) or see this community member's [article](https://dlthub.com/blog/multi-asset-rest-api-pipelines) for alternative approaches.
