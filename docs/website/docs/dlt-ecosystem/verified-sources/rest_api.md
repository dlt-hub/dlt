...
| [OAuth2ClientCredentialsFlow](../../general-usage/http/rest-client.md#oauth20-authorization) | `oauth2` | OAuth 2.0 authorization with a temporary access token obtained from the authorization server. |
