...
_Big thanks to Evan Phillips and [swishbi.com](https://swishbi.com/) for contributing code, time, and a test environment._
...
- If **no** _staging_volume_name_ **is provided**, dlt creates a **default volume** automatically.
- **For production**, explicitly setting _staging_volume_name_ is recommended.
