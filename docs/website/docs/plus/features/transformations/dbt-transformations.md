...
- Additionally, the **dlt dbt generate** lets you define relationships between the schema tables, which can be used to automatically create fact tables.
