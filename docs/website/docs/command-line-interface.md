...
Generates and launches a simple [Streamlit](https://streamlit.io/) app where you can inspect your pipeline state, loading status / statsm and also explore generated schemas and data in the destination's dataset. Requires `streamlit` to be installed.