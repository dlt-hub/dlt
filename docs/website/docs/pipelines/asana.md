...
2. Replace the va   lue of **`access_token`** with the one that you copied above*. This will ensure that your data pipeline can access your Asana resources securely.
