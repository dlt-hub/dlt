...
resource_metrics = trace.last_extract_info.metrics[load_id][0]["resource_metrics"]["purchases"]  # ty: ignore
...
[Read more →](../dlt-ecosystem/verified-sources/filesystem/index.md#quick-example)
