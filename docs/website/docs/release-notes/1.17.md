...
print("Custom metrics:", pipeline.last_trace.last_extract_info.metrics)  # ty: ignore
```
...
[Learn more →](../dlt-ecosystem/verified-sources/filesystem#5-incremental-loading)
