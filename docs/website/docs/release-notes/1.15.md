...
[The AI command](https://dlthub.com/docs/reference/command-line-interface#dlt-ai) now detects and supports all major IDEs, automatically copying the correct rule files for each environment. This ensures seamless integration whether you’re using Cursor, Copilot, Windsurf, Claude, or other supported editors.
