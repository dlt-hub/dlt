...
:::note
**dltHub offers two products**: `dlt` (open source) and **dltHub** (commercial, license-gated). Each product is made of several components — this page maps them out so you know what each one is and how to access it.
...
| What you want to do | `dlt` | dltHub |
|---|---|---|
| Run a Python ingestion pipeline | ✅ | ✅ |
| Build pipelines with an AI coding agent | — | ✅ |
| Data quality checks & transformations (Python/dbt) | — | ✅ |
| Managed runtime: deploy, schedule, monitor | — | ✅ |
| Premium sources/destinations (Iceberg, MSSQL CT, …) | — | ✅ |
| Self-host anywhere Python runs | ✅ | ✅ (local CLI) |
| Cost | Free (Apache 2.0) | Paid, 30-day trial |
...
| Name | What it actually is | How to access it | Belongs to |
|---|---|---|---|
...
| **`dlthub` library** | Python package with data quality, transformations, premium sources/destinations | [PyPI](https://pypi.org/project/dlthub/) | dltHub |
