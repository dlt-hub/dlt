---
title: "Advanced example: starter pack"
description: A full worked example deploying pipelines, dashboards, and transformations on the managed dltHub platform using the runtime starter pack
keywords: [deployment, dlthub, dashboard, dlt pipeline, starter pack, example]
---

# Advanced example: the runtime starter pack

This is a longer, end-to-end worked example built around the
[`runtime-starter-pack`](https://github.com/dlt-hub/runtime-starter-pack) repository. It goes beyond a first deployment
to show pipelines, interactive notebooks, public links, scheduling, and a full set of transformations together in one
workspace.
