...
| Build pipelines with the [dltHub AI Harness](../ai-harness/introduction.md) | — | ✅ |
...
| **AI Toolkits** | The dltHub AI Harness: a collection of toolkits made of skills, rules, workflows, and MCP wiring that drive agentic pipeline development inside Claude Code, Cursor, and Codex.                                                                                                                                                                                                                                                                  | [`dlt-hub/dlthub-ai-workbench`](https://github.com/dlt-hub/dlthub-ai-workbench) — source-available under [its own license](https://github.com/dlt-hub/dlthub-ai-workbench/blob/master/LICENSE) | [Agent-native workflow walkthrough](../ingestion/rest-api-source.md)                                            |
| **dltHub Context** | Per-source agent contexts (specs, endpoint documentation, prompts) that prime your coding assistant for thousands of APIs. Automatically used by AI Harness                                                                                                                                                                                                                                                                                        | Browse and copy contexts at [dlthub.com/context](https://dlthub.com/context)                                                                   | [Build a source with AI](../ingestion/init.md#agentic-setup)                                                                      |
