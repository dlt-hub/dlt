...
Now you're ready to deploy your Workspace to the dltHub platform and [schedule your pipeline to run](../getting-started/tutorials/deploy-your-first-pipeline.md#5-schedule-the-pipeline).
...
* [Deploy your pipeline](../getting-started/tutorials/deploy-your-first-pipeline.md)
