...
<details>
  <summary>Location: on-backend vs. in-memory</summary>
...
<details>
    <summary>Timing: lazy vs. eager</summary>
    ...
    :::info
    See [this page](./transformation_libraries.md) for a review of the execution location & timing of transformation libraries and their pros and cons. 
    :::
