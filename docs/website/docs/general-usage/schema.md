...
- do not support naive timestamps (ie. Athena) and will interpret them as naive UTC by attaching UTC timezone
...
### Handling nulls
In general, destinations are responsible for null enforcement. 
