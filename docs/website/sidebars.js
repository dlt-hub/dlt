      ...
      items: [
        'walkthroughs/share-a-dataset',
        {
          ...
          link: {
            ...
            slug: 'walkthroughs/deploy_a_pipeline',
          },
          items: [
            'walkthroughs/deploy_a_pipeline/deploy-with-github-actions',
            'walkthroughs/deploy_a_pipeline/deploy-with-airflow-composer',
            'reference/explainers/airflow-gcp-cloud-composer',
            'walkthroughs/deploy_a_pipeline/deploy-with-google-cloud-functions',
            'walkthroughs/deploy_a_pipeline/deploy-gcp-cloud-function-as-webhook',
            'walkthroughs/deploy_a_pipeline/deploy-with-kestra',
            'walkthroughs/deploy_a_pipeline/deploy-with-dagster',
            'walkthroughs/deploy_a_pipeline/deploy-with-prefect',
            'walkthroughs/deploy_a_pipeline/deploy-with-modal',
          ]
        },
        {
          type: 'category',
