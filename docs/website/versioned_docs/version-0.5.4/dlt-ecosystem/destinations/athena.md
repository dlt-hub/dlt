...
- [Load data from Zuora to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/zuora/load-data-with-python-from-zuora-to-athena)
...
- [Load data from Zendesk to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-athena)
...
- [Load data from GitLab to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/gitlab/load-data-with-python-from-gitlab-to-athena)
