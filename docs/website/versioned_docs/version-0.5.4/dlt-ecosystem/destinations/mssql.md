...
- [Load data from The Local Filesystem to Microsoft SQL Server in python with dlt](https://dlthub.com/docs/pipelines/filesystem-local/load-data-with-python-from-filesystem-local-to-mssql)
