...
- [Load data from Coinbase to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/coinbase/load-data-with-python-from-coinbase-to-snowflake)
- [Load data from Harvest to Snowflake in python with dlt](https://dlthub.com/docs/pipelines/harvest/load-data-with-python-from-harvest-to-snowflake)
