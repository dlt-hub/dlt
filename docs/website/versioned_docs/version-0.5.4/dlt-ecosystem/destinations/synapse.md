...
- [Load data from Pipedrive to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/pipedrive/load-data-with-python-from-pipedrive-to-synapse)
...
- [Load data from Apple App-Store Connect to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/apple_app_store_connect/load-data-with-python-from-apple_app_store_connect-to-synapse)
...
- [Load data from Cisco Meraki to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/cisco_meraki/load-data-with-python-from-cisco_meraki-to-synapse)
- [Load data from MySQL to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/sql_database_mysql/load-data-with-python-from-sql_database_mysql-to-synapse)
