...
- [Load data from Shopify to EDB BigAnimal in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-biganimal)
...
- [Load data from Shopify to Neon Serverless Postgres in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-neondb)
