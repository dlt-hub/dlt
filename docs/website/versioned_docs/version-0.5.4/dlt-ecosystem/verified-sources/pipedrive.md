...
- [Load data from Pipedrive to Azure Cloud Storage in python with dlt](https://dlthub.com/docs/pipelines/pipedrive/load-data-with-python-from-pipedrive-to-filesystem-az)
...
- [Load data from Pipedrive to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/pipedrive/load-data-with-python-from-pipedrive-to-filesystem-local)
