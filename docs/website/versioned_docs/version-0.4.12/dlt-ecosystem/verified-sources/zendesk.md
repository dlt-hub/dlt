...
- [Load data from Zendesk to AlloyDB in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-alloydb)
...
- [Load data from Zendesk to Neon Serverless Postgres in python with dlt](https://dlthub.com/docs/pipelines/zendesk/load-data-with-python-from-zendesk-to-neondb)
