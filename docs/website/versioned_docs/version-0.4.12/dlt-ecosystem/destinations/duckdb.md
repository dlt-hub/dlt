...
- [Load data from Jira to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/jira/load-data-with-python-from-jira-to-duckdb)
- [Load data from Chargebee to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/chargebee/load-data-with-python-from-chargebee-to-duckdb)
