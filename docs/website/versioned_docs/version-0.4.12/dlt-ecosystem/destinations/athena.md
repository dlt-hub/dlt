...
- [Load data from MongoDB to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/mongodb/load-data-with-python-from-mongodb-to-athena)
- [Load data from PostgreSQL to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/sql_database_postgres/load-data-with-python-from-sql_database_postgres-to-athena)
- [Load data from Imgur to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/imgur/load-data-with-python-from-imgur-to-athena)
...
- [Load data from Soundcloud to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/soundcloud/load-data-with-python-from-soundcloud-to-athena)
...
- [Load data from Oracle Database to AWS Athena in python with dlt](https://dlthub.com/docs/pipelines/sql_database_oracle/load-data-with-python-from-sql_database_oracle-to-athena)
