...
- [Load data from DigitalOcean to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/digitalocean/load-data-with-python-from-digitalocean-to-duckdb)
- [Load data from Looker to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/looker/load-data-with-python-from-looker-to-duckdb)
...
- [Load data from Star Trek to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/startrek/load-data-with-python-from-startrek-to-duckdb)
...
- [Load data from Bitbucket to DuckDB in python with dlt](https://dlthub.com/docs/pipelines/bitbucket/load-data-with-python-from-bitbucket-to-duckdb)
