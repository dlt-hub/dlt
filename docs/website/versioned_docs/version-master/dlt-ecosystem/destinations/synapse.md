...
- [Load data from Bitbucket to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/bitbucket/load-data-with-python-from-bitbucket-to-synapse)
- [Load data from Oracle Database to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/sql_database_oracle/load-data-with-python-from-sql_database_oracle-to-synapse)
- [Load data from Clubhouse to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/clubhouse/load-data-with-python-from-clubhouse-to-synapse)
- [Load data from Crypt API to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/crypt_api/load-data-with-python-from-crypt_api-to-synapse)
...
- [Load data from Fivetran to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/fivetran/load-data-with-python-from-fivetran-to-synapse)
- [Load data from Klaviyo to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/klaviyo/load-data-with-python-from-klaviyo-to-synapse)
...
- [Load data from Qualtrics to Azure Synapse in python with dlt](https://dlthub.com/docs/pipelines/qualtrics/load-data-with-python-from-qualtrics-to-synapse)
