...
- [Load data from Shopify to The Local Filesystem in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-filesystem-local)
- [Load data from Shopify to PostgreSQL in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-postgres)
...
- [Load data from Shopify to Microsoft SQL Server in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-mssql)
- [Load data from Shopify to CockroachDB in python with dlt](https://dlthub.com/docs/pipelines/shopify_dlt/load-data-with-python-from-shopify_dlt-to-cockroachdb)
