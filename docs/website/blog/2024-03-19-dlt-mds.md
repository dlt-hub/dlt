...
Before the Pythonic modern data stack, we had Saas vendors and custom python scripts, and it sucked.
...
<div style="text-align: center;">
  <img src="https://storage.googleapis.com/dlt-blog-images/java_pipeline.gif" alt="Java Pipeline" style="width: 100%; height: auto;">
</div>
