...
if __name__ == "__main__":
    ...
    fmt.note(
        "Welcome to Grammar Fixer 3000, run 'python fix_grammar_gpt.py --help' for"
        " help."
    )
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Fixes the grammar of our docs with open ai. Requires an .env file with the"
            " open ai key."
        ),
    ...
    parser.add_argument(
        ...
        "--files",
        help=(
            "Specify the file name. Grammar Checker will filter all .md files"
            " containing this string in the filepath."
        ),
        type=str,
    )
