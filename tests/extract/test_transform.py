...
def test_transform_pivot_single_path() -> None:
    ...
    assert result == [
        {
            "a.inner_1": [{"col0": 1, "col1": 1, "col2": 1}, {"col0": 2, "col1": 2, "col2": 2}],
            "a.inner_2": [{"col0": 3, "col1": 3, "col2": 3}, {"col0": 4, "col1": 4, "col2": 4}],
        },
        {
            "a.inner_1": [{"col0": 8, "col1": 8, "col2": 8}, {"col0": 9, "col1": 9, "col2": 9}],
            "a.inner_2": [
...
def test_pandas_dataframe_pivot() -> None:
    ...
    result = list(res)
    assert result == [
        {"$": [{"col0": 1, "col1": 3, "col2": 5}]},
        {"$": [{"col0": 2, "col1": 4, "col2": 6}]},
    ]
