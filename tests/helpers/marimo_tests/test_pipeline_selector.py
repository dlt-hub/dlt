...
def test_cell_pipeline_locations():
    _, defs = _pipeline_selector.pipeline_locations.run()  # type: ignore[misc,unused-ignore]
...
def test_cell_pipeline_selector():
    _, defs = _pipeline_selector.pipeline_selector.run()  # type: ignore[misc,unused-ignore]
...
def test_cell_outputs():
    _, defs = _pipeline_selector.outputs.run()  # type: ignore[misc,unused-ignore]
