...
def test_cell_pipeline_browser():
    ...
    _, defs = _load_package_viewer.pipeline_browser.run(**kwargs)  # type: ignore[misc,unused-ignore]
...
def test_cell_file_viewer():
    ...
    _, defs = _load_package_viewer.file_viewer.run(**kwargs)  # type: ignore[misc,unused-ignore]
