...
def test_sql_queries(populated_pipeline: Pipeline) -> None:
    ...
    assert query_relationship._sqlglot_expression == query_from_query_function._sqlglot_expression
...
def test_ibis_expression_relation(populated_pipeline: Pipeline) -> None:
    ...
    assert (
        ...
        == relation.columns
        == relation._ipython_key_completions_()
        == ["id", "double_id"]
    )
    ...
    assert (
        ...
        == agg_relation.columns
        == agg_relation._ipython_key_completions_()
        == ["sum_id"]
    )
...
def test_standalone_dataset(populated_pipeline: Pipeline) -> None:
    ...
    dataset = dlt.dataset(
        ...
        name=populated_pipeline.dataset_name,
