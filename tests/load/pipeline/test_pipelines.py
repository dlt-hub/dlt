...
def test_parquet_loading(destination_config: DestinationTestConfiguration) -> None:
    ...
    #     columns_schema["col11_precision"]["precision"] = None
    ...
    #     columns_schema["col4_precision"]["precision"] = 6
    ...
    with pipeline.sql_client() as sql_client:
        ...
        assert_all_data_types_row(
            ...
            always_returns_naive_datetimes=destination_config.destination_type
            in ["athena", "dremio"],
        )
