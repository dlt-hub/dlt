...
@pytest.mark.essential
def test_switch_to_merge(destination_config: DestinationTestConfiguration, with_root_key: bool, mocker: MockerFixture):
    pipeline = destination_config.setup_pipeline(
    ...
    norm_config: RelationalNormalizerConfig = pipeline.default_schema._normalizers_config["json"]
