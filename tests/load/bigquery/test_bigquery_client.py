...
from tests.utils import TEST_STORAGE_ROOT, delete_test_storage, preserve_environ, ALL_DESTINATIONS
...
pytestmark = pytest.mark.skipif('bigquery' not in ALL_DESTINATIONS, reason="BigQuery not configured")
