...
def test_extract_source_twice() -> None:
    ...
    s = DltSource("module", dlt.Schema("source"), [dlt.resource(some_data())])
...
def test_disable_enable_state_sync(environment: Any) -> None:
    ...
    s = DltSource("module", dlt.Schema("default"), [dlt.resource(some_data())])
    dlt.pipeline().extract(s)
    ...
    s = DltSource("module", dlt.Schema("default_2"), [dlt.resource(some_data())])
    dlt.pipeline().extract(s)
    expect_extracted_file(storage, "default", s.schema.state_table_name, "***")


def test_extract_multiple_sources() -> None:
    s1 = DltSource("module", dlt.Schema("default"), [dlt.resource([1, 2, 3], name="resource_1"), dlt.resource([3, 4, 5], name="resource_2")])
    s2 = DltSource("module", dlt.Schema("default_2"), [dlt.resource([6, 7, 8], name="resource_3"), dlt.resource([9, 10, 0], name="resource_4")])
    ...
    s3 = DltSource("module", dlt.Schema("default_3"), [dlt.resource([1, 2, 3], name="resource_1"), dlt.resource([3, 4, 5], name="resource_2")])
