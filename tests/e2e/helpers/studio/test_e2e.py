...
def _goto_tab(
    page: Page,
    tab: Literal[
        "Overview", "Schema", "Browse Data", "Last Trace", "State", "Loads", "Ibis-Browser"
    ],
) -> None:
